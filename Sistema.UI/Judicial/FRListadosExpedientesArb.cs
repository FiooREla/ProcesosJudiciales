...
{
    public partial class FRListadosExpedientesArb : FBaseForm
    {
        ContextoModelo CtxModelo = new ContextoModelo();
        public FRListadosExpedientesArb()
        {
            InitializeComponent();
        ...
        private void GenerarDiasSemana()
        {
            ...
            lviewReports =
                CtxModelo.viewExpedienteReport.Where(x => x.FechaEdicion >= dInicio && x.FechaEdicion <= dFin && x.TipoExpediente == "EXPEDIENTEARBITRAL").ToList();
